...
Network* construct_gtsrb_net() {
  ...
  network_add(net, make_conv_layer(224, 224, 3, 3, 64, 1, 1));
  ...
  network_add(net, make_conv_layer(net->layers[2]->out_sx, net->layers[2]->out_sy, net->layers[2]->out_depth, 3, 128, 1, 1));
  ...
  network_add(net, make_conv_layer(net->layers[5]->out_sx, net->layers[5]->out_sy, net->layers[5]->out_depth, 3, 256, 1, 1));
  network_add(net, make_relu_layer(net->layers[6]->out_sx, net->layers[6]->out_sy, net->layers[6]->out_depth));
  network_add(net, make_conv_layer(net->layers[7]->out_sx, net->layers[7]->out_sy, net->layers[7]->out_depth, 3, 256, 1, 1));
  network_add(net, make_relu_layer(net->layers[8]->out_sx, net->layers[8]->out_sy, net->layers[8]->out_depth));
  network_add(net, make_max_pool_layer(net->layers[9]->out_sx, net->layers[9]->out_sy, net->layers[9]->out_depth, 2, 2));

  network_add(net, make_conv_layer(net->layers[10]->out_sx, net->layers[10]->out_sy, net->layers[10]->out_depth, 3, 512, 1, 1));
  network_add(net, make_relu_layer(net->layers[11]->out_sx, net->layers[11]->out_sy, net->layers[11]->out_depth));
  network_add(net, make_conv_layer(net->layers[12]->out_sx, net->layers[12]->out_sy, net->layers[12]->out_depth, 3, 512, 1, 1));
  network_add(net, make_relu_layer(net->layers[13]->out_sx, net->layers[13]->out_sy, net->layers[13]->out_depth));
  network_add(net, make_max_pool_layer(net->layers[14]->out_sx, net->layers[14]->out_sy, net->layers[14]->out_depth, 2, 2));

  network_add(net, make_conv_layer(net->layers[15]->out_sx, net->layers[15]->out_sy, net->layers[15]->out_depth, 3, 512, 1, 1));
  network_add(net, make_relu_layer(net->layers[16]->out_sx, net->layers[16]->out_sy, net->layers[16]->out_depth));
  network_add(net, make_conv_layer(net->layers[17]->out_sx, net->layers[17]->out_sy, net->layers[17]->out_depth, 3, 512, 1, 1));
  network_add(net, make_relu_layer(net->layers[18]->out_sx, net->layers[18]->out_sy, net->layers[18]->out_depth));
  network_add(net, make_max_pool_layer(net->layers[19]->out_sx, net->layers[19]->out_sy, net->layers[19]->out_depth, 2, 2));


  network_add(net, make_fc_layer(net->layers[20]->out_sx, net->layers[20]->out_sy, net->layers[20]->out_depth, 4096));
  network_add(net, make_fc_layer(net->layers[21]->out_sx, net->layers[21]->out_sy, net->layers[21]->out_depth, 4096));
  network_add(net, make_fc_layer(net->layers[22]->out_sx, net->layers[22]->out_sy, net->layers[22]->out_depth, 1000));

  network_add(net, make_softmax_layer(net->layers[23]->out_sx, net->layers[23]->out_sy, net->layers[23]->out_depth));
...
int main(int argc, char** argv) {
  int NUM_PASSES = 100;
  if (argc < 3) {
    fprintf(stderr, "Usage: ./VGG <test|summary> [NUMBER_PASSES]\n");
    return 2;
  }
  else{
