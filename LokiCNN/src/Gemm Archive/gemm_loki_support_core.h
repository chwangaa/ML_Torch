                   ...
                   )
{
    ...
    asm volatile (
      ...
      "ldadd r14, r28, 0x04 -> 1 \n"
      "ldadd r18, r28, 0x08 -> 1 \n"
      "ldadd r22, r28, 0x0c -> 1 \n"
      ...
      "ldadd r12, r28, 0x00 -> 1 \n"
      "ldadd r16, r28, 0x04 -> 1 \n"
      "ldadd r20, r28, 0x08 -> 1 \n"
      "ldadd r24, r28, 0x0c -> 1 \n"
         ...
         const void* data1)
{
    ...
    set_channel_map(3, addr);
    addr = loki_mem_address(0, core, CH_REGISTER_5, GROUPSIZE_8, false, false, false, false);  
    set_channel_map(4, addr);
    addr = loki_mem_address(0, core, CH_REGISTER_6, GROUPSIZE_8, false, false, false, false);  
    set_channel_map(5, addr);
    if(core == 0){
        int bitmask = all_cores_except_0(MATRIX_NUM_CORE);
        addr = loki_mcast_address(bitmask, 6, false);
        set_channel_map(6, addr);
    }
